...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#F9F9FB] dark:bg-[#121212] transition-colors duration-300 w-full">
      <div className="w-full max-w-5xl mx-auto bg-white dark:bg-[#121212] min-h-screen shadow-sm pb-24">
        ...
        <section ref={sectionRef} className="mt-8 px-6 md:px-12 pt-2">
          {loading && (
        ...
        {cutoffY > 0 && (
          <div
            className="fixed left-0 right-0 mx-auto w-full max-w-5xl bottom-0 z-30 flex flex-col items-center justify-end pb-12 pointer-events-none transition-colors duration-300"
            style={{
              top: `${cutoffY - 120}px`,
              background:
                theme === "dark"
                  ? "linear-gradient(to bottom, transparent 0%, rgba(18,18,18,0.8) 30%, rgba(18,18,18,0.98) 60%, #121212 90%)"
                  : "linear-gradient(to bottom, transparent 0%, rgba(249,249,251,0.8) 30%, rgba(249,249,251,0.98) 60%, #F9F9FB 90%)",
            }}
          >
            <div className="pointer-events-auto">
              <button
                onClick={() => openAuthModal("register")}
                className="bg-[#492775] text-white dark:bg-[#A395DA] dark:text-[#1E1E40] px-10 py-4 rounded-full font-bold text-[15px] shadow-lg hover:bg-[#3a1f5d] dark:hover:bg-[#8B7BB5] transition-all transform hover:scale-105 duration-300 cursor-pointer"
              >
