...
export default function CreatePostPage() {
  ...
  return (
    <main className="min-h-screen bg-white dark:bg-[#121212] flex flex-col relative transition-colors duration-300">
        ...
        <button
          ...
          className={`px-5 py-1.5 rounded-full font-bold text-[13px] transition-all duration-200 ${
            (content.trim() || imageFile) && !publishing
              ...
              : "bg-[#F3F4F6] dark:bg-[#2A2438] text-gray-400 dark:text-gray-600 cursor-not-allowed"
          }`}
        >
      ...
      <div className="px-4 py-5 flex gap-3 flex-1 overflow-y-auto pb-24" onClick={() => setShowEmojiPicker(false)}>
        ...
        <div className="flex-1 flex flex-col gap-4">
          <textarea
            ...
            className="w-full bg-transparent resize-none outline-none text-[#1E1E40] dark:text-[#F9F9FB] text-[15px] min-h-[120px] placeholder-gray-400 dark:placeholder-gray-600 transition-colors duration-300"
            autoFocus
          />

          {imagePreview && (
            <div className="relative rounded-2xl overflow-hidden bg-[#F5F0FF] dark:bg-[#2A2438] border border-[#E0D8F0] dark:border-[#3A304D] transition-colors duration-300">
      ...
      {showEmojiPicker && (
        <div className="fixed bottom-[72px] left-0 right-0 max-w-md mx-auto z-30 shadow-2xl">
          <EmojiPicker
      ...
      <div className="fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-white dark:bg-[#121212] border-t border-gray-100 dark:border-gray-800 p-4 flex gap-5 z-20 transition-colors duration-300">
        <button onClick={() => fileInputRef.current?.click()} className="text-[#A395DA] hover:text-[#492775] dark:hover:text-[#D0C9E8] transition-colors cursor-pointer">
        ...
        <button
          ...
          className={`${showEmojiPicker ? "text-[#492775] dark:text-[#D0C9E8]" : "text-[#A395DA]"} hover:text-[#492775] dark:hover:text-[#D0C9E8] transition-colors cursor-pointer`}
        >
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <button onClick={handleAddHashtag} className="text-[#A395DA] hover:text-[#492775] dark:hover:text-[#D0C9E8] transition-colors cursor-pointer">
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
