...
export default function Navbar() {
  ...
  if (pathname === "/" || pathname === "/login" || pathname === "/register" || pathname === "/create-post") {
    return null;
  }
    ...
    <nav className="fixed bottom-6 left-4 right-4 max-w-md mx-auto bg-[#C8BFE9] rounded-3xl sm:hidden z-50 shadow-lg">
      <div className="flex justify-around items-center h-20 px-4">
        ...
        <button
          ...
          className="flex items-center justify-center w-14 h-14 bg-[#492775] rounded-2xl shadow-[0_4px_20px_rgba(73,39,117,0.35)] hover:bg-[#3a1f5d] active:scale-95 transition-all duration-300"
